...
SHOW_CELL = false -- false = Show total battery voltage / true = Show cell average (default = false)
BATTLOW = 3.5     -- Battery low warning cell voltage (default = 3.5)
BATTCRIT = 3.4    -- Battery critically low warning cell voltage (default = 3.4)
WAVPATH = "/SCRIPTS/TELEMETRY/iNav/" -- Path to iNav telemetry WAV files

local vars=loadfile(WAVPATH .. "iNavVars.lua")
vars()
vars = nil
