...
local distSensor = getTelemetryId("0420") > -1 and "0420" or (getTelemetryId("Dist") > -1 and "Dist" or "0007")
local data = {
  rssiLow = low,
  rssiCrit = crit,
  ...
  distance_unit = getTelemetryUnit(distSensor),
