...
if docfg == false then
    ...
    config2[13].l = {[0] = "Aus", "Auto", "Timer1", "Timer2", "Timer3"}	-- "Off", "Auto", "Timer1", "Timer2", "Timer3"
    config2[14].l = {[0] = "Aus", "An"}								-- "Off", "On"
    config2[16].l = {[0] = "Dezimal", "Grad/Min"}					-- "Decimal", "Deg/Min"
    ...
    config2[25].l = {[0] = "Klassisch", "Pilot", "Radar", "Hoehe"}	-- "Classic", "Pilot", "Radar", "Altitude"
