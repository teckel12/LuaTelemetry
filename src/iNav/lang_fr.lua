...
if docfg == false then
    ...
    config2[7].l =  {[0] = "Eteint", "Graphique", "Voix", "Les deux"}-- "Off", "Graph", "Voice", "Both"
    ...
    config2[13].l = {[0] = "Eteint", "Auto", "Chrono1", "Chrono2", "Chrono3"}	-- "Off", "Auto", "Timer1", "Timer2", "Timer3"
    config2[14].l = {[0] = "Eteint", "Actif"}						-- "Off", "On"
    --config2[16].l = {[0] = "Decimal", "Deg/Min"}					-- "Decimal", "Deg/Min"
    config2[19].l = {[0] = "Numerique", "Graphique", "Les deux"}		-- "Number", "Graph", "Both"
    --config2[20].l = {[0] = "GPS", "Pitot"}							-- "GPS", "Pitot"
    config2[22].l = {[0] = "Graphique", "Decimal"}					-- "Graph", "Decimal"
